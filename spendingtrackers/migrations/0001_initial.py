# Generated by Django 4.1.3 on 2023-02-21 18:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spending_limit', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receipt', models.ImageField(blank=True, upload_to='receipt_images')),
                ('category_fk', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='spendingtrackers.category')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
